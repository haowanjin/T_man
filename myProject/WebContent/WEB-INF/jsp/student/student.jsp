    ...
    <div data-options="region:'west',title:'菜单',split:true" style="width:180px;">
    	<ul id="menu" class="easyui-tree" style="margin-top: 10px;margin-left: 5px;">
         	<li>
        		<span>课程信息查看</span>
         		<ul>
	         		<li data-options="attributes:{'url':'courselist'}">查看可选课程</li>
	         		<li data-options="attributes:{'url':'selectedcourse'}">查看已选课程</li>
	         	</ul>
         	</li>
         	<li>
         		<span>个人信息查看</span>
         		<ul>
	         		<li data-options="attributes:{'url':'showMyself/${user.sid}'}">查看个人信息</li>
