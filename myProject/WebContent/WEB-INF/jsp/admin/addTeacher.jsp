...
<body>
	...
	<div class="easyui-panel" title="添加教师" style="width:400px">
		<div style="padding:10px 60px 20px 60px">
	    <form id="atff" class="easyui-form" data-options="novalidate:true">
	    	<table cellpadding="5">
	    		<tr>
	    			<td>职工号:</td>
	    			<td><input class="easyui-textbox" type="text" name="tid" data-options="required:true"></input></td>
	    		</tr>
	    		<tr>
	    			<td>姓名:</td>
	...
	function submitForm(){
		$('#atff').form('submit',{
			onSubmit:function(){
				$.post("${pageContext.request.contextPath}/admin/insertTeacher",$("#atff").serialize(),function(data){
					alert("添加成功!");
